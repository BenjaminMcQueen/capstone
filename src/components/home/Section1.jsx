    ...
    <div className="section1">
      <div className="img-container">
        ...
        <div className="overlay">
          ...
          <div className="anchor-box lighten-on-hover">
            <a href="https://www.google.com/search?q=cincinnati+visit&oq=cincinnati+visit&aqs=chrome..69i57j69i64j69i60.4333j0j4&sourceid=chrome&ie=UTF-8#ip=1" target="_blank" rel="noreferrer">
              Learn more
            </a>
          </div>
        </div>
